...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative h-screen overflow-hidden bg-sage-100">
      {/* Image Slider */}
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl animate-fade-in">
          <div className="glass mx-auto inline-block px-4 py-1 rounded-full mb-6">
            <p className="text-sm text-primary font-medium">Premium Decoration Services</p>
          </div>
          ...
          <p className="text-lg sm:text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Vikash Vatika offers premium balloon and flower decorations for all your special occasions, creating unforgettable memories.
          </p>
